...
{
	private int iCodDetalleFactura;
	...
	public int CodDetalleFactura
	{
		get
		{
			return iCodDetalleFactura;
		}
		set
		{
			iCodDetalleFactura = value;
		}
	}
	...
	{
		if (CodDetalleFactura == other.CodDetalleFactura && CodAlmacen == other.CodAlmacen)
		{
			return true;
		}
		return false;

...
public class frmVariantes : Office2007Form
{
	private clsAdmVariante AdmVar = new clsAdmVariante();

	private clsVariante var = new clsVariante();

	public int CaracteristicaSeleccionada;
	...
	private void btnEliminar_Click(object sender, EventArgs e)
	{
		if (dgvVariantes.CurrentRow.Index != -1 && var.CodVariante != 0)
		{
			...
			if (dlgResult != DialogResult.No && AdmVar.delete(var.CodVariante))
			{
				MessageBox.Show("Los datos han sido eliminado correctamente", "Variante", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CargaLista();
			}
		}
	}
	...
	private void btnGuardar_Click(object sender, EventArgs e)
	{
		...
		if (Proceso == 1)
		{
			...
			{
				MessageBox.Show("Los datos se guardaron correctamente", "Gestion Variante", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CambiarEstados(Estado: true);
				CargaLista();
			}
		}
		else if (Proceso == 2 && AdmVar.update(var))
		{
			MessageBox.Show("Los datos se guardaron correctamente", "Gestion Variante", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			CambiarEstados(Estado: true);
			CargaLista();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.frmVariantes));
		...
		this.dgvVariantes.Columns.AddRange(this.codigo, this.Caracteristica, this.descripcion, this.estado, this.coduser, this.fecha);
		...
		this.dgvVariantes.ColumnHeaderMouseClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(dgvVariantes_ColumnHeaderMouseClick_1);
		this.dgvVariantes.RowStateChanged += new System.Windows.Forms.DataGridViewRowStateChangedEventHandler(dgvVariantes_RowStateChanged_1);
		...
		base.Name = "frmVariantes";
		base.ShowInTaskbar = false;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "Variantes";
		base.Load += new System.EventHandler(frmVariantes_Load);
		base.Shown += new System.EventHandler(frmVariantes_Shown);

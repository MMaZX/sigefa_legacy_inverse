...
public class frmEmpresaTransporte : Office2007Form
{
	...
	private DataGridView dgvEmpresaTransporte;
	...
	private void btnEliminar_Click(object sender, EventArgs e)
	{
		if (dgvEmpresaTransporte.CurrentRow.Index != -1 && emp.CodEmpresaTranporte != 0)
		{
			...
			if (dlgResult != DialogResult.No && AdmET.delete(emp.CodEmpresaTranporte))
			{
				MessageBox.Show("Los datos han sido eliminado correctamente", "EmpresaTransporte", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CargaLista();
			}
		}
	}
	...
	private void btnGuardar_Click(object sender, EventArgs e)
	{
		if (btnGuardar.Text == "Guardar")
		{
			...
			if (Proceso == 1)
			{
				...
				if (AdmET.insert(emp))
				{
					MessageBox.Show("Los datos se guardaron correctamente", "Gestion EmpresaTransporte", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
					CambiarEstados(Estado: true);
					CargaLista();
					Proceso = 0;
				}
			}
			else if (Proceso == 2 && AdmET.update(emp))
			{
				MessageBox.Show("Los datos se guardaron correctamente", "Gestion EmpresaTransporte", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CambiarEstados(Estado: true);
				CargaLista();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.frmEmpresaTransporte));
		...
		this.dgvEmpresaTransporte.Columns.AddRange(this.codigo, this.ruc, this.razonsocial, this.direccion, this.telefono, this.estado, this.coduser, this.fecha);
		...
		this.dgvEmpresaTransporte.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(dgvEmpresaTransportes_CellDoubleClick);
		this.dgvEmpresaTransporte.ColumnHeaderMouseClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(dgvEmpresaTransportes_ColumnHeaderMouseClick);
		this.dgvEmpresaTransporte.CellClick += new System.Windows.Forms.DataGridViewCellEventHandler(dgvEmpresaTransportes_CellClick);
		this.dgvEmpresaTransporte.RowStateChanged += new System.Windows.Forms.DataGridViewRowStateChangedEventHandler(dgvEmpresaTransportes_RowStateChanged);
		...
		this.customValidator4.ValidateValue += new DevComponents.DotNetBar.Validator.ValidateValueEventHandler(customValidator3_ValidateValue);
		...
		base.Name = "frmEmpresaTransporte";
		base.ShowInTaskbar = false;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "Empresa Transporte";
		base.Load += new System.EventHandler(frmEmpresaTransporte_Load);
		base.Shown += new System.EventHandler(frmEmpresaTransporte_Shown);

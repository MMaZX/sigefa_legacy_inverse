...
public class frmProveedores : Office2007Form
{
	...
	private DataGridViewTextBoxColumn telefonoemp;

	private DataGridViewTextBoxColumn representante;

	private DataGridViewTextBoxColumn telefonorep;

	private DataGridViewTextBoxColumn contacto;

	private DataGridViewTextBoxColumn frecuenciavisita;
	...
	private void btnEliminar_Click(object sender, EventArgs e)
	{
		if (dgvProveedores.CurrentRow.Index != -1 && prov.CodProveedor != 0)
		{
			...
			if (dlgResult != DialogResult.No && AdmProv.delete(Convert.ToInt32(prov.CodProveedor)))
			{
				MessageBox.Show("El Proveedor ha sido eliminado", "Proveedores", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CargaLista();
			}
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.frmProveedores));
		...
		this.dgvProveedores.Columns.AddRange(this.codproveedor, this.ruc, this.razonsocial, this.direccion, this.telefonoemp, this.representante, this.telefonorep, this.contacto, this.frecuenciavisita, this.margen, this.estado);
		...
		this.dgvProveedores.ColumnHeaderMouseClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(dgvProveedores_ColumnHeaderMouseClick);
		this.dgvProveedores.RowStateChanged += new System.Windows.Forms.DataGridViewRowStateChangedEventHandler(dgvProveedores_RowStateChanged);
		...
		base.Controls.Add(this.dgvProveedores);
		base.Controls.Add(this.ribbonBar2);
		this.DoubleBuffered = true;
		base.KeyPreview = true;
		base.Name = "frmProveedores";
		base.ShowInTaskbar = false;
		this.Text = "Proveedores";
		base.WindowState = System.Windows.Forms.FormWindowState.Maximized;
		base.Load += new System.EventHandler(frmProveedores_Load);
		base.Shown += new System.EventHandler(frmProveedores_Shown);
		base.KeyDown += new System.Windows.Forms.KeyEventHandler(frmProveedores_KeyDown);

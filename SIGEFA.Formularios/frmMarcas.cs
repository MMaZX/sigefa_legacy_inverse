...
public class frmMarcas : Office2007Form
{
	private clsAdmMarca AdmMar = new clsAdmMarca();

	private clsMarca mar = new clsMarca();
	...
	private void btnGuardar_Click(object sender, EventArgs e)
	{
		...
		else if (Proceso == 2 && AdmMar.update(mar))
		{
			MessageBox.Show("Los datos se guardaron correctamente", "Gestion Familia", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			CambiarEstados(Estado: true);
			CargaLista();
	...
	private void btnEliminar_Click(object sender, EventArgs e)
	{
		if (dgvMarcas.CurrentRow.Index != -1 && mar.CodMarca != 0)
		{
			...
			if (dlgResult != DialogResult.No && AdmMar.delete(mar.CodMarca))
			{
				MessageBox.Show("Los datos han sido eliminado correctamente", "Marcas", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CargaLista();
			}
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.frmMarcas));
		...
		this.dgvMarcas.Columns.AddRange(this.codigo, this.descripcion, this.estado, this.coduser, this.fecha);
		...
		this.dgvMarcas.ColumnHeaderMouseClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(dgvMarcas_ColumnHeaderMouseClick);
		this.dgvMarcas.RowStateChanged += new System.Windows.Forms.DataGridViewRowStateChangedEventHandler(dgvMarcas_RowStateChanged);
		...
		base.Shown += new System.EventHandler(frmMarcas_Shown);

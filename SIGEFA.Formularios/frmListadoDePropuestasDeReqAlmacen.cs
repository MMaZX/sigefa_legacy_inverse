...
public class frmListadoDePropuestasDeReqAlmacen : Form
{
	...
	public frmListadoDePropuestasDeReqAlmacen()
	{
		InitializeComponent();
	}
	...
	private void listaPropuestaOrdenDeCompraSegunFecha()
	{
		...
		data.DataSource = admPropuestaDePedido.listadoPropuestaOrdenDeCompraSegunFecha(1, Convert.ToInt32(cmbAlmacenes.SelectedValue), frmLogin.iCodSucursal, cmbFechasFiltrar.SelectedIndex, dtpDesde.Value.Date, dtpHasta.Value.Date);
	...
	public void listaPropuestaOrdenDeCompra()
	{
		rgvlistadopropuesta.AutoGenerateColumns = false;
		rgvlistadopropuesta.DataSource = data;
		data.DataSource = admPropuestaDePedido.listadoPropuestaOrdenDeCompra(1, Convert.ToInt32(cmbAlmacenes.SelectedValue), frmLogin.iCodSucursal);
		data.Filter = string.Empty;
		rgvlistadopropuesta.ClearSelection();
	}
	...
	private void btnReporte_Click(object sender, EventArgs e)
	{
		try
		{
			...
			rpt.SetDataSource(dso.listadopropuestasdepedido(1, Convert.ToInt32(cmbAlmacenes.SelectedValue), frmLogin.iCodSucursal, frmLogin.iCodEmpresa, cmbFechasFiltrar.SelectedIndex, dtpDesde.Value.Date, dtpHasta.Value.Date).Tables[0]);
	...
	private void btnExcel_Click(object sender, EventArgs e)
	{
		try
		{
			...
			sl.SetCellValue(indFilaInicial, 1, "Listado de Propuestas de Requerimiento de Almacen");
			indFilaInicial++;
	...
	{
		rgvlistadopropuesta.DataSource = data;
		data.DataSource = admPropuestaDePedido.MuestraPropuestaxProducto(1, cmbFechasFiltrar.SelectedIndex, dtpDesde.Value.Date, dtpHasta.Value.Date, Convert.ToInt32(cmbAlmacenes.SelectedValue), frmLogin.iCodSucursal, Convert.ToInt32(txtCodprod.Text));
	}
	...
	private void rgvlistadopropuesta_KeyUp(object sender, KeyEventArgs e)
	{
		try
		{
			if (e.KeyCode != Keys.Delete || rgvlistadopropuesta.SelectedRows.Count != 1)
			{
				return;
			}
	...
	private void InitializeComponent()
	{
		...
		this.groupBox1.Text = "Listado De Propuestas Para Requerimiento de Almacen";
		...
		gridViewTextBoxColumn12.FieldName = "codigoPropuesta";
		gridViewTextBoxColumn12.HeaderText = "Codigo";
		gridViewTextBoxColumn12.Name = "colcodigoPropuesta";
		gridViewTextBoxColumn13.FieldName = "nombre";
		gridViewTextBoxColumn13.HeaderText = "Titulo";
		gridViewTextBoxColumn13.Name = "coltitulo";
		gridViewTextBoxColumn13.Width = 195;
		gridViewTextBoxColumn14.FieldName = "descripcion";
		gridViewTextBoxColumn14.HeaderText = "Descripcion";
		gridViewTextBoxColumn14.Name = "coldescripcion";
		gridViewTextBoxColumn14.Width = 191;
		gridViewTextBoxColumn15.FieldName = "codigoAlmacen";
		gridViewTextBoxColumn15.HeaderText = "codalmacen";
		gridViewTextBoxColumn15.IsVisible = false;
		gridViewTextBoxColumn15.Name = "colcodAlmacen";
		gridViewTextBoxColumn16.FieldName = "descripAlmacen";
		gridViewTextBoxColumn16.HeaderText = "Almacen";
		gridViewTextBoxColumn16.Name = "coldescripalmacen";
		gridViewTextBoxColumn16.TextAlignment = System.Drawing.ContentAlignment.MiddleCenter;
		gridViewTextBoxColumn16.Width = 128;
		gridViewTextBoxColumn17.FieldName = "fechaRegistro";
		gridViewTextBoxColumn17.HeaderText = "Fecha Registro";
		gridViewTextBoxColumn17.Name = "colfechaRegistro";
		gridViewTextBoxColumn17.TextAlignment = System.Drawing.ContentAlignment.MiddleRight;
		gridViewTextBoxColumn17.Width = 152;
		gridViewTextBoxColumn18.FieldName = "fechaEdicion";
		gridViewTextBoxColumn18.HeaderText = "Fecha Edicion";
		gridViewTextBoxColumn18.Name = "colFechaEdicion";
		gridViewTextBoxColumn18.TextAlignment = System.Drawing.ContentAlignment.MiddleRight;
		gridViewTextBoxColumn18.Width = 152;
		gridViewTextBoxColumn19.FieldName = "nombreUsuario";
		gridViewTextBoxColumn19.HeaderText = "coduser";
		gridViewTextBoxColumn19.IsVisible = false;
		gridViewTextBoxColumn19.Name = "colnombreusuario";
		gridViewTextBoxColumn20.FieldName = "fechaGeneracion";
		gridViewTextBoxColumn20.HeaderText = "Fecha Generacion R.A.";
		gridViewTextBoxColumn20.Name = "colfechaGeneracion";
		gridViewTextBoxColumn20.TextAlignment = System.Drawing.ContentAlignment.MiddleRight;
		gridViewTextBoxColumn20.Width = 152;
		gridViewTextBoxColumn21.FieldName = "ctdadDias";
		gridViewTextBoxColumn21.HeaderText = "Ctdad Dias";
		gridViewTextBoxColumn21.Name = "colCtdadDias";
		gridViewTextBoxColumn21.TextAlignment = System.Drawing.ContentAlignment.MiddleCenter;
		gridViewTextBoxColumn21.Width = 101;
		gridViewTextBoxColumn22.FieldName = "estado";
		gridViewTextBoxColumn22.HeaderText = "Estado";
		gridViewTextBoxColumn22.Name = "colestado";
		gridViewTextBoxColumn22.TextAlignment = System.Drawing.ContentAlignment.MiddleCenter;
		gridViewTextBoxColumn22.Width = 155;
		this.rgvlistadopropuesta.MasterTemplate.Columns.AddRange(gridViewTextBoxColumn12, gridViewTextBoxColumn13, gridViewTextBoxColumn14, gridViewTextBoxColumn15, gridViewTextBoxColumn16, gridViewTextBoxColumn17, gridViewTextBoxColumn18, gridViewTextBoxColumn19, gridViewTextBoxColumn20, gridViewTextBoxColumn21, gridViewTextBoxColumn22);
		...
		this.rgvlistadopropuesta.MasterTemplate.ViewDefinition = tableViewDefinition2;
		...
		this.cmbFechasFiltrar.Items.AddRange(new object[4] { "Ninguno", "Fecha de Registro", "Fecha de Edicion", "Fecha de Generacion R.A." });
		...
		this.cmbFiltroEstado.Items.AddRange(new object[3] { "Todos", "Pendiente", "R.A. Generado" });
		...
		base.Name = "frmListadoDePropuestasDeReqAlmacen";
		this.Text = "Listado De Propuestas De Requerimiento de Almacen";

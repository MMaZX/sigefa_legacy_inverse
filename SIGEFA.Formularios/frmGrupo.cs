...
public class frmGrupo : Office2007Form
{
	...
	private void btnGuardar_Click(object sender, EventArgs e)
	{
		...
		if (Proceso == 1)
		{
			...
			{
				MessageBox.Show("Los datos se guardaron correctamente", "Gestion Grupo", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CambiarEstados(Estado: true);
				CargaLista();
			}
		}
		else if (Proceso == 2 && AdmGru.update(gru))
		{
			MessageBox.Show("Los datos se guardaron correctamente", "Gestion Grupo", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			CambiarEstados(Estado: true);
			CargaLista();
	...
	private void btnEliminar_Click(object sender, EventArgs e)
	{
		if (dgvGrupos.CurrentRow.Index != -1 && gru.CodGrupo != 0)
		{
			...
			if (dlgResult != DialogResult.No && AdmGru.delete(gru.CodGrupo))
			{
				MessageBox.Show("Los datos han sido eliminado correctamente", "Grupo", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CargaLista();
			}
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.frmGrupo));
		...
		this.dgvGrupos.Columns.AddRange(this.codigo, this.Linea, this.referencia, this.descripcion, this.estado, this.coduser, this.fecha);
		...
		this.dgvGrupos.ColumnHeaderMouseClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(dgvGrupos_ColumnHeaderMouseClick);
		this.dgvGrupos.RowStateChanged += new System.Windows.Forms.DataGridViewRowStateChangedEventHandler(dgvGrupos_RowStateChanged);
		...
		this.Text = "Grupos";
		base.Load += new System.EventHandler(frmGrupo_Load);
		base.Shown += new System.EventHandler(frmGrupo_Shown);

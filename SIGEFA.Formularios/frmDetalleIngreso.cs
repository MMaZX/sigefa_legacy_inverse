...
public class frmDetalleIngreso : Office2007Form
{
	...
	public frmOrdenCompra formulario_o_c_padre = null;
	...
	private void txtCodigo_TextChanged(object sender, EventArgs e)
	{
		...
		else if (Procede == 10)
		{
			...
			if (formulario_o_c_padre != null)
			{
				form = (frmOrdenCompra)Application.OpenForms["frmOrdenCompra"];
			}
			else
			{
				form = formulario_o_c_padre;
			}
	...
	private void btnGuardar_Click(object sender, EventArgs e)
	{
		try
		{
			pro.CodProducto = int.Parse(txtReferencia.Text.Trim());
			DataTable dt = admPro.MuestraUnidadesEquivalentes(pro.CodProducto, frmLogin.iCodAlmacen);
			if (!Enumerable.Any<DataRow>(dt.Rows.Cast<DataRow>(), (Func<DataRow, bool>)((DataRow x) => x["descripcion"].ToString() == cmbUnidad.Text)))
			{
				MessageBox.Show("¡Falta agregar la unidad de medida " + cmbUnidad.Text + " a la tabla equivalentes!, por favor valide.", "AVISO", MessageBoxButtons.OK);
			}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.frmDetalleIngreso));
		...
		this.cmbs.Location = new System.Drawing.Point(564, -2);
		this.cmbs.Name = "cmbs";
		this.cmbs.Size = new System.Drawing.Size(140, 21);
		this.cmbs.TabIndex = 25;
		this.cmbs.Visible = false;
		base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		base.CancelButton = this.btnSalir;
		base.ClientSize = new System.Drawing.Size(855, 252);
		base.Controls.Add(this.cmbs);

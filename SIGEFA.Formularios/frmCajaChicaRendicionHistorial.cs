...
public class frmCajaChicaRendicionHistorial : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.frmCajaChicaRendicionHistorial));
		...
		this.dgvRendiciones.Columns.AddRange(this.codigo, this.codPersonalizado, this.concepto, this.fecha, this.numDocumento, this.numGuia, this.numRecLiquidacion, this.codTipoPagoCaja, this.tipopagocaja, this.cargadescarga, this.tipoMovimiento, this.toneladas, this.monto);
		...
		base.ClientSize = new System.Drawing.Size(984, 466);
		...
		base.Name = "frmCajaChicaRendicionHistorial";

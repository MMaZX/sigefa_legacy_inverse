...
public class frmAprobacionPagos : Office2007Form
{
	...
	private DataGridViewTextBoxColumn NUMCTACTE;
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.frmAprobacionPagos));
		...
		this.cmbEstado.Items.AddRange(new object[4] { "", "POR APROBAR", "APROBADOS", "DESAPROBADOS" });
		...
		this.dgvDetalle.Columns.AddRange(this.DOCUMENTO, this.METODOPAGO, this.BANCO, this.NUMCTACTE, this.NOPERACION, this.NCHEQUE, this.MONTOCOBRADO, this.MONEDA, this.OBSERVACION, this.Aprobado1, this.codPago);

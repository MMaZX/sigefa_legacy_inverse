...
public class frmCaracteristicas : Office2007Form
{
	private clsAdmCaracteristica AdmCar = new clsAdmCaracteristica();

	private clsCaracteristica car = new clsCaracteristica();
	...
	private void btnGuardar_Click(object sender, EventArgs e)
	{
		...
		if (Proceso == 1)
		{
			...
			{
				MessageBox.Show("Los datos se guardaron correctamente", "Gestion Caracteristica", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CambiarEstados(Estado: true);
				CargaLista();
			}
		}
		else if (Proceso == 2 && AdmCar.update(car))
		{
			MessageBox.Show("Los datos se guardaron correctamente", "Gestion Caracteristica", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			CambiarEstados(Estado: true);
			CargaLista();
	...
	private void btnEliminar_Click(object sender, EventArgs e)
	{
		if (dgvCaracteristicas.CurrentRow.Index != -1 && car.CodCaracteristica != 0)
		{
			...
			if (dlgResult != DialogResult.No && AdmCar.delete(car.CodCaracteristica))
			{
				MessageBox.Show("Los datos han sido eliminado correctamente", "Caracteristica", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CargaLista();
			}
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.frmCaracteristicas));
		...
		this.btnVariantes.Click += new System.EventHandler(btnVariantes_Click);
		...
		this.dgvCaracteristicas.Columns.AddRange(this.codigo, this.descripcion, this.estado, this.coduser, this.fecha);
		...
		this.dgvCaracteristicas.ColumnHeaderMouseClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(dgvCaracteristicas_ColumnHeaderMouseClick);
		...
		base.Name = "frmCaracteristicas";
		base.ShowInTaskbar = false;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "Caracteristicas";
		base.Load += new System.EventHandler(frmCaracteristicas_Load);
		base.Shown += new System.EventHandler(frmCaracteristicas_Shown);

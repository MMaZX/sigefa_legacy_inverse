...
public class reporteventasdiarias : RadForm
{
	...
	private int añadiendoSumatoria(SLDocument sl, int fila_excel, DateTime aux_fecha, int codalma)
	{
		...
		sl.SetCellValue("H" + fila_excel, "TOTAL INGRESOS (1-5)");
		...
		sl.SetCellValue("H" + fila_excel, "SALDO CAJA SISTEMA(6 - 2 - 3 - 4)");
		sl.SetCellValue("I" + fila_excel, "=I" + ifilaTotalIngreso + "-I" + ifilaTotalTarjeta + "-I" + ifilaTotalTransferencia + "-I" + ifilaTotalDeposito);
		sl.SetCellStyle("I" + fila_excel, style);
		sl.SetCellValue("J" + fila_excel, "=J" + ifilaTotalIngreso + "-J" + ifilaTotalTarjeta + "-J" + ifilaTotalTransferencia + "-J" + ifilaTotalDeposito);
		sl.SetCellStyle("J" + fila_excel, style);
		sl.SetCellValue("K" + fila_excel, "=SUM(I" + fila_excel + ":J" + fila_excel + ")");
		sl.SetCellStyle("K" + fila_excel, style);
		int ifilaTotalSaldoCajaSistema = fila_excel;
		style_bg = sl.CreateStyle();
		style_bg.Fill.SetPattern(PatternValues.Solid, System.Drawing.Color.FromArgb(84, 130, 53), System.Drawing.Color.Blue);
		sl.SetCellStyle("F" + ifilaTotalSaldoCajaSistema, style_bg);
		asignarBordes(style_bg);
		sl.SetCellStyle("H" + ifilaTotalSaldoCajaSistema, "K" + ifilaTotalSaldoCajaSistema, style_bg);
		...
		sl.SetCellStyle("H" + fila_excel, "K" + fila_excel, style_con_bordes);
		asignarBordes(style_bg);
		sl.SetCellValue("H" + fila_excel, "SALDO EFECTIVO (7-8-9)");
		sl.SetCellValue("K" + fila_excel, "=SUM(K" + ifilaTotalSaldoCajaSistema + "-K" + posEgresos + ")");
		sl.SetCellStyle("K" + fila_excel, style);
		...
		if (ingresos_caja_chica.Rows.Count > 0)
		{
			double total3 = 0.0;
			double total4 = 0.0;
			foreach (DataRow fila_v7 in ingresos_caja_chica.Rows)
			{
				sl.SetCellStyle("H" + fila_excel, "K" + fila_excel, style_con_bordes);
				asignarBordes(style_bg);
				sl.SetCellValue("H" + fila_excel, fila_v7.ItemArray[6].ToString() + " - " + fila_v7.ItemArray[5].ToString());
				if (Convert.ToInt32(fila_v7.ItemArray[22] ?? ((object)0)) == idalmacen1)
				{
					sl.SetCellValue("I" + fila_excel, Convert.ToDouble(fila_v7.ItemArray[7] ?? ((object)0)));
					sl.SetCellStyle("I" + fila_excel, style);
					total3 += Convert.ToDouble(fila_v7.ItemArray[7] ?? ((object)0));
				}
				else
				{
					sl.SetCellValue("J" + fila_excel, Convert.ToDouble(fila_v7.ItemArray[7] ?? ((object)0)));
					sl.SetCellStyle("J" + fila_excel, style);
					total4 += Convert.ToDouble(fila_v7.ItemArray[7] ?? ((object)0));
				}
				sl.SetCellValue("K" + fila_excel, "=SUM(I" + fila_excel + ":J" + fila_excel + ")");
				sl.SetCellStyle("K" + fila_excel, style);
				fila_excel++;
			...
			asignarBordes(style_bg);
			sl.SetCellStyle("H" + fila_excel, "K" + fila_excel, style_bg);
			sl.SetCellValue("H" + fila_excel, "TOTAL INGRESOS CAJA");
		...
		asignarBordes(style_bg);
		sl.SetCellStyle("H" + fila_excel, "K" + fila_excel, style_con_bordes);
		sl.SetCellValue("H" + fila_excel, "TOTAL A DEPOSITAR");
		sl.SetCellValue("K" + fila_excel, "=SUM(K" + ifilaTotalSaldoCajaSistema + "-K" + posEgresos + "+K" + posIngresos + ")");
		sl.SetCellStyle("K" + fila_excel, style);
		return fila_excel;
	}
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.reporteventasdiarias));
		...
		this.btnReporte.Location = new System.Drawing.Point(156, 139);
		...
		base.Name = "reporteventasdiarias";

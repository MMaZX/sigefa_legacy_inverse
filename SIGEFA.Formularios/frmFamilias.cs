...
public class frmFamilias : Office2007Form
{
	...
	private void btnGuardar_Click(object sender, EventArgs e)
	{
		...
		else if (Proceso == 2 && AdmFam.update(fam))
		{
			MessageBox.Show("Los datos se guardaron correctamente", "Gestion Familia", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			CambiarEstados(Estado: true);
			CargaLista();
	...
	private void btnEliminar_Click(object sender, EventArgs e)
	{
		if (dgvFamilias.CurrentRow.Index != -1 && fam.CodFamilia != 0)
		{
			...
			if (dlgResult != DialogResult.No && AdmFam.delete(fam.CodFamilia))
			{
				MessageBox.Show("Los datos han sido eliminado correctamente", "Familia", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CargaLista();
			}
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.frmFamilias));
		...
		this.btnLineas.Click += new System.EventHandler(btnLineas_Click);
		...
		this.dgvFamilias.Columns.AddRange(this.codigo, this.referencia, this.descripcion, this.estado, this.coduser, this.fecha);
		...
		this.dgvFamilias.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(dgvFamilias_CellDoubleClick);
		this.dgvFamilias.ColumnHeaderMouseClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(dgvFamilias_ColumnHeaderMouseClick);
		this.dgvFamilias.RowStateChanged += new System.Windows.Forms.DataGridViewRowStateChangedEventHandler(dgvFamilias_RowStateChanged);
		...
		base.Name = "frmFamilias";
		base.ShowInTaskbar = false;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "Familias";
		base.Load += new System.EventHandler(frmFamilias_Load);
		base.Shown += new System.EventHandler(frmFamilias_Shown);

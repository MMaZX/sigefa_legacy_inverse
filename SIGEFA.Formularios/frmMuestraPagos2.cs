...
public class frmMuestraPagos2 : Office2007Form
{
	...
	private void dgvPagos_CellContentClick(object sender, DataGridViewCellEventArgs e)
	{
		...
		if (dlgResult != DialogResult.No)
		{
			...
			{
				MessageBox.Show("Los datos han sido eliminado correctamente", "Pagos", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CargaLista();
			}
		}
	}
	...
	private void InitializeComponent()
	{
		...
		this.dgvPagos.Columns.AddRange(this.codpago, this.fecha, this.moneda, this.monto, this.tipopago, this.noperacion, this.ncheque, this.cobrador, this.accion);
		...
		base.Name = "frmMuestraPagos2";
		base.ShowInTaskbar = false;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "Muestra Pagos";
		base.Load += new System.EventHandler(frmMuestraPagos2_Load);

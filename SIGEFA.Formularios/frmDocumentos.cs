...
public class frmDocumentos : Office2007Form
{
	...
	private void btnGuardar_Click(object sender, EventArgs e)
	{
		if (btnGuardar.Text == "Guardar")
		{
			...
			if (Proceso == 1)
			{
				...
				{
					MessageBox.Show("Los datos se guardaron correctamente", "Gestion Documentos", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
					CambiarEstados(Estado: true);
					CargaLista();
				}
			}
			else if (Proceso == 2 && AdmDoc.update(doc))
			{
				MessageBox.Show("Los datos se guardaron correctamente", "Gestion Documentos", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CambiarEstados(Estado: true);
				CargaLista();
	...
	private void btnEliminar_Click(object sender, EventArgs e)
	{
		if (dgvDocumentos.CurrentRow.Index != -1 && doc.CodTipoDocumento != 0)
		{
			...
			if (dlgResult != DialogResult.No && AdmDoc.delete(doc.CodTipoDocumento))
			{
				MessageBox.Show("Los datos han sido eliminado correctamente", "Documento", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
				CargaLista();
			}
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SIGEFA.Formularios.frmDocumentos));
		...
		this.dgvDocumentos.Columns.AddRange(this.codigo, this.sigla, this.descripcion, this.estado, this.coduser, this.fecha);
		...
		this.btnSeries.Click += new System.EventHandler(btnSeries_Click);
		...
		base.Load += new System.EventHandler(frmDocumentos_Load);
		base.Shown += new System.EventHandler(frmDocumentos_Shown);

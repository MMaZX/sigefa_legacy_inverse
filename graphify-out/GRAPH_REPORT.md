# Graph Report - sigefa_legacy  (2026-06-23)

## Corpus Check
- 1272 files · ~1,113,494 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25163 nodes · 35208 edges · 1840 communities (1136 shown, 704 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 409 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `40925999`
...
2. `frmVenta2019` - 288 edges
3. `frmVenta` - 244 edges
4. `EventArgs` - 235 edges
5. `frmNotaIngreso` - 190 edges
6. `frmVentaxEentregar` - 168 edges
7. `frmGuiaRemision` - 165 edges
8. `frmGeneraVenta` - 159 edges
9. `MysqlProducto` - 157 edges
10. `frmNotadeCredito` - 155 edges

## Surprising Connections (you probably didn't know these)
- `clsAdmAperturaCierre` --references--> `IAperturaCierre`  [EXTRACTED]
  SIGEFA.Administradores/clsAdmAperturaCierre.cs → SIGEFA.Interfaces/IAperturaCierre.cs
- `MysqlAperturaCierreCaja` --implements--> `IAperturaCierre`  [EXTRACTED]
  SIGEFA.InterMySql/MysqlAperturaCierreCaja.cs → SIGEFA.Interfaces/IAperturaCierre.cs
- `_Application` --inherits--> `AppEvents_Event`  [EXTRACTED]
  Microsoft.Office.Interop.Excel/_Application.cs → Microsoft.Office.Interop.Excel/AppEvents_Event.cs
- `_Worksheet` --inherits--> `DocEvents_Event`  [EXTRACTED]
  Microsoft.Office.Interop.Excel/_Worksheet.cs → Microsoft.Office.Interop.Excel/DocEvents_Event.cs
- `_Workbook` --inherits--> `WorkbookEvents_Event`  [EXTRACTED]
  Microsoft.Office.Interop.Excel/_Workbook.cs → Microsoft.Office.Interop.Excel/WorkbookEvents_Event.cs

## Import Cycles
- None detected.

## Communities (1840 total, 704 thin omitted)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (38): clsTipoCambioSunat, clsValidarSGE, ComboItem, LabelItem, Office2007RibbonForm, RibbonControl, RibbonPanel, RibbonTabItem (+30 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (95): BindingSource, bool, Button, ButtonX, CheckBox, CheckBoxX, clsAdmAlmacen, clsAdmAperturaCierre (+87 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (83): BindingSource, bool, Button, CachedCRCuotasPrestamo, CheckBox, clsAdmAlmacen, clsAdmAperturaCierre, clsAdmAutorizado (+75 more)
...
Cohesion: 0.06
Nodes (28): RadMultiColumnComboBox, bool, clsAdmCotizacion, clsAdmFormaPago, clsAdmMoneda, clsAdmOrdenCompraCotizacion, clsAdmProducto, clsAdmUsuario (+20 more)
...
Cohesion: 0.04
Nodes (28): Form, IContainer, PictureBox, frmCargando, CrystalReportViewer, IContainer, frmListaNotasDebito, CrystalReportViewer (+20 more)
...
Cohesion: 0.05
Nodes (25): Button, clsAdmTipoPagoCaja, clsAdmVehiculoTransporte, clsTipoPagoCaja, clsValidar, ComboBox, CompareValidator, CustomValidator (+17 more)
...
Cohesion: 0.04
Nodes (44): AdmIngresosEgresos, bool, Button, clsAdmAlmacen, clsAdmAperturaCierre, clsAdmBanco, clsAdmCtaCte, clsAdmMetodoPago (+36 more)
...
Cohesion: 0.14
Nodes (3): clsAlmacen, DataTable, IAlmacen

### Community 334 - "Community 334"
Cohesion: 0.12
Nodes (3): clsCliente, DataTable, ICliente

### Community 335 - "Community 335"
Cohesion: 0.10
Nodes (14): clsReporteGananciaxCliente, ButtonX, clsAdmCliente, clsCliente, DateTimePicker, EventArgs, GroupPanel, IContainer (+6 more)
...
Cohesion: 0.11
Nodes (10): IClinica, clsConexionMysql, clsDetalleHistoria, clsHistoria, clsPaciente, DataTable, MySqlCommand, MySqlDataAdapter (+2 more)

### Community 338 - "Community 338"
Cohesion: 0.12
Nodes (9): ILibrosElectronicos, clsConexionMysql, clsLibrosElectronicos, clsRegistroElectronico, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader (+1 more)

### Community 339 - "Community 339"
Cohesion: 0.12
Nodes (4): clsAdmCliente, clsCliente, DataTable, ICliente

### Community 340 - "Community 340"
Cohesion: 0.11
Nodes (14): BindingSource, Button, clsAdmCliente, clsCliente, DataGridView, DataGridViewRowStateChangedEventArgs, DataGridViewTextBoxColumn, EventArgs (+6 more)

### Community 341 - "Community 341"
Cohesion: 0.09
Nodes (18): clsAdmAlmacen, clsAdmCliente, clsAdmEmpresa, clsAdmFacturaVenta, clsAdmRepositorio, clsCliente, clsEmpresa, clsFacturaVenta (+10 more)

### Community 342 - "Community 342"
Cohesion: 0.11
Nodes (14): BindingSource, clsAdmOrdenCompraCotizacion, clsOrdenCompraCotizacion, EventArgs, GridViewCellEventArgs, IContainer, Label, RadButton (+6 more)

### Community 344 - "Community 344"
Cohesion: 0.09
Nodes (16): Button, clsAdmAlmacen, clsAdmTipoArticulo, clsConsultasExternas, clsSerie, ComboBox, DataGridView, DataGridViewTextBoxColumn (+8 more)

### Community 345 - "Community 345"
Cohesion: 0.11
Nodes (13): bool, Button, clsAdmTipoDocumento, ComboBox, DateTimePicker, EventArgs, GroupBox, IContainer (+5 more)

### Community 346 - "Community 346"
Cohesion: 0.10
Nodes (16): Button, CheckBox, clsAdmEmpresa, clsAdmNotaIngreso, clsAdmRequerimiento, clsValidar, EventArgs, GroupBox (+8 more)

### Community 347 - "Community 347"
Cohesion: 0.12
Nodes (5): clsCotizacion, clsDetalleCotizacion, DataTable, DateTime, ICotizacion

### Community 348 - "Community 348"
Cohesion: 0.12
Nodes (7): clsDetallePlantillaDeProductos, clsPlantillaDeProductos, clsProducto, DataTable, DateTime, List, IPlantillaDeProductos

### Community 349 - "Community 349"
Cohesion: 0.10
Nodes (14): BindingSource, ButtonX, clsAdmFacturaVenta, DataGridView, DataGridViewAutoFilterTextBoxColumn, DataGridViewTextBoxColumn, DateTimePicker, EventArgs (+6 more)
...
Cohesion: 0.11
Nodes (13): clsReporteDocumentosEnviados, BindingSource, ButtonX, clsAdmAlmacen, clsAdmTipoDocumento, ComboBox, DateTimePicker, EventArgs (+5 more)

### Community 352 - "Community 352"
Cohesion: 0.12
Nodes (9): IEmpresa, clsConexionMysql, clsEmpresa, clsParametros, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader (+1 more)

### Community 353 - "Community 353"
Cohesion: 0.11
Nodes (11): IGuiaFacturacion, clsConexionMysql, clsDetalleGuiaFacturacion, clsGuiaFacturacion, DataTable, DateTime, MySqlCommand, MySqlDataAdapter (+3 more)

### Community 354 - "Community 354"
Cohesion: 0.16
Nodes (11): IRepositorio, clsConexionMysql, clsRepositorio, DateTime, List, MySqlCommand, MySqlDataAdapter, MySqlDataReader (+3 more)
...
Cohesion: 0.11
Nodes (10): Component, CachedCRCobrosGeneral, ReportDocument, RequestContext, CachedCRVentCredContDia, ReportDocument, RequestContext, CachedCRVentxArtixVend (+2 more)
...
Cohesion: 0.16
Nodes (4): clsEmpresa, clsParametros, DataTable, IEmpresa

### Community 451 - "Community 451"
Cohesion: 0.16
Nodes (3): clsSerie, DataTable, ISerie

### Community 453 - "Community 453"
Cohesion: 0.19
Nodes (8): clsReporteCaja, clsConexionMysql, DataSet, DataTable, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 454 - "Community 454"
Cohesion: 0.13
Nodes (11): clsAdmMovimientoStock, Button, clsAdmAlmacen, ComboBox, DateTimePicker, EventArgs, GroupBox, IContainer (+3 more)

### Community 455 - "Community 455"
Cohesion: 0.15
Nodes (9): IMarca, clsConexionMysql, clsMarca, DataTable, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader (+1 more)

### Community 456 - "Community 456"
Cohesion: 0.16
Nodes (8): IMetodoPago, clsConexionMysql, clsMetodoPago, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader, MysqlMetodoPago

### Community 457 - "Community 457"
Cohesion: 0.24
Nodes (5): clsAdmRepositorio, clsRepositorio, DateTime, IRepositorio, List

### Community 458 - "Community 458"
Cohesion: 0.18
Nodes (4): clsAdmTipoDocumento, clsTipoDocumento, DataTable, ITipoDocumento

### Community 459 - "Community 459"
Cohesion: 0.19
Nodes (3): clsValidar, KeyPressEventArgs, TextBox

### Community 460 - "Community 460"
Cohesion: 0.15
Nodes (7): EventArgs, FormClosingEventArgs, IContainer, KeyEventArgs, Label, TextBox, frmBusqueda

### Community 464 - "Community 464"
Cohesion: 0.13
Nodes (11): Button, clsAdmAlmacen, ComboBox, DataGridView, DataGridViewTextBoxColumn, DateTimePicker, EventArgs, IContainer (+3 more)

### Community 466 - "Community 466"
Cohesion: 0.13
Nodes (11): Button, clsAdmUnidad, clsUnidadMedida, EventArgs, GroupBox, IContainer, ImageList, int (+3 more)

### Community 468 - "Community 468"
Cohesion: 0.15
Nodes (10): BindingSource, ButtonItem, clsAdmProducto, clsProducto, EventArgs, IContainer, RadGridView, RibbonBar (+2 more)
...
Cohesion: 0.17
Nodes (3): clsDetallePlantillaDeProductos, DataRow, DataTable

### Community 504 - "Community 504"
Cohesion: 0.12
Nodes (4): DataGridViewCellCancelEventArgs, DataGridViewCellEventArgs, DataGridViewRow, DataGridViewRowsAddedEventArgs

### Community 505 - "Community 505"
Cohesion: 0.27
Nodes (4): clsRepositorio, DateTime, List, IRepositorio

### Community 506 - "Community 506"
Cohesion: 0.20
Nodes (3): clsTipoDocumento, DataTable, ITipoDocumento

### Community 507 - "Community 507"
Cohesion: 0.24
Nodes (6): clsReporteFlujoCaja, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter

### Community 508 - "Community 508"
Cohesion: 0.17
Nodes (8): clsReportProductos, clsConexionMysql, DataSet, DataTable, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader
...
Cohesion: 0.17
Nodes (8): IBanco, clsBanco, clsConexionMysql, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader, MysqlBanco

### Community 511 - "Community 511"
Cohesion: 0.15
Nodes (9): ICategoriaCliente, clsCategoriaCliente, clsConexionMysql, clsZona, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader (+1 more)

### Community 512 - "Community 512"
Cohesion: 0.17
Nodes (8): IFamilias, clsConexionMysql, clsFamilia, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader, MysqlFamilia

### Community 513 - "Community 513"
Cohesion: 0.16
Nodes (9): IPrestamoBancario, clsConexionMysql, clsPrestamoBancario, DataTable, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader (+1 more)

### Community 514 - "Community 514"
Cohesion: 0.16
Nodes (9): IRecibo, clsConexionMysql, clsRecibos, DataTable, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader (+1 more)

### Community 515 - "Community 515"
Cohesion: 0.16
Nodes (8): ITarjetaPago, clsConexionMysql, clsTarjetaPago, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader, MysqlTarjetaPago
...
Cohesion: 0.15
Nodes (9): BindingSource, clsAdmOrdenCompra, DataGridView, DataGridViewTextBoxColumn, EventArgs, IContainer, int, string (+1 more)
...
Cohesion: 0.16
Nodes (8): bool, CrystalReportViewer, DataSet, double, EventArgs, IContainer, int, rptInventario

### Community 580 - "Community 580"
Cohesion: 0.21
Nodes (4): clsFlujoCaja, DataTable, DateTime, IFlujoCaja

### Community 581 - "Community 581"
Cohesion: 0.22
Nodes (3): clsFormaPago, DataTable, IFormaPago

### Community 583 - "Community 583"
Cohesion: 0.18
Nodes (5): clsDetalleSeparacionVenta, clsSeparacion, DataTable, DateTime, ISeparacion

### Community 584 - "Community 584"
Cohesion: 0.18
Nodes (4): clsTransaccion, DataTable, List, ITransaccion

### Community 585 - "Community 585"
Cohesion: 0.19
Nodes (3): clsUnidadMedida, DataTable, IUnidad

### Community 587 - "Community 587"
Cohesion: 0.18
Nodes (8): clsConexionMysql, clsOficio, DataTable, List, MySqlCommand, MySqlDataAdapter, MySqlDataReader, MysqlOficio

### Community 589 - "Community 589"
Cohesion: 0.18
Nodes (7): clsConexionMysql, clsTecnico, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader, MysqlTecnico

### Community 590 - "Community 590"
Cohesion: 0.15
Nodes (9): Button, clsReporteFlujoCaja, DateTimePicker, EventArgs, GroupBox, IContainer, ImageList, Label (+1 more)

### Community 591 - "Community 591"
Cohesion: 0.18
Nodes (7): clsReportAlmacenVendeMas, Button, DateTimePicker, EventArgs, IContainer, Label, frmAlmacenVendeMas

### Community 592 - "Community 592"
Cohesion: 0.18
Nodes (8): ICuotaSeparacion, clsConexionMysql, clsCuotasSeparacion, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader, MysqlCuotaSeparacion

### Community 593 - "Community 593"
Cohesion: 0.15
Nodes (9): INotaDebito, clsConexionMysql, clsDetalleNotaDebito, clsNotaDebito, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader (+1 more)
...
Cohesion: 0.33
Nodes (4): clsDetalleTransferencia, clsRequerimientoAlmacen, clsTransferencia, List

### Community 612 - "Community 612"
Cohesion: 0.22
Nodes (3): clsMoneda, DataTable, IMoneda

### Community 613 - "Community 613"
Cohesion: 0.17
Nodes (8): clsConexionMysql, DataTable, DateTime, List, MySqlCommand, MySqlDataAdapter, MySqlDataReader, MysqlMovimientoStock

### Community 614 - "Community 614"
Cohesion: 0.15
Nodes (9): bool, CookieContainer, Image, Resul, SslPolicyErrors, string, X509Certificate, X509Chain (+1 more)

### Community 615 - "Community 615"
Cohesion: 0.23
Nodes (6): clsReporteFactura, clsConexionMysql, DataSet, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 616 - "Community 616"
Cohesion: 0.26
Nodes (7): clsReporteGananciaxArticulo, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 617 - "Community 617"
Cohesion: 0.27
Nodes (7): clsReporteVentasxVendedor, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 618 - "Community 618"
Cohesion: 0.18
Nodes (7): Button, clsReporteInformeSucursal, DateTimePicker, EventArgs, IContainer, Label, frmParamCobranzaSucursal

### Community 619 - "Community 619"
Cohesion: 0.17
Nodes (8): Button, clsReporteFlujoCaja, DateTimePicker, EventArgs, IContainer, ImageList, Label, frmParamLiquidacionCaja

### Community 620 - "Community 620"
Cohesion: 0.18
Nodes (7): Button, clsReporteInformeSucursal, DateTimePicker, EventArgs, IContainer, Label, frmParamVentCredContSucursal
...
Cohesion: 0.20
Nodes (8): INotaIngresoIgv, clsConexionMysql, clsNotaIngresoIgv, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader, MysqlNotaIngresoIgv

### Community 724 - "Community 724"
Cohesion: 0.24
Nodes (7): IUnidadEquivalente, clsConexionMysql, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader, MysqlUnidadEquivalente

### Community 725 - "Community 725"
Cohesion: 0.20
Nodes (5): clsAdmArqueoFondoFijo, clsArqueoFondoFijo, clsDetalleArqueFondoFijo, DataTable, IArqueoFondoFijo

### Community 726 - "Community 726"
Cohesion: 0.24
Nodes (4): clsAdmAutorizado, clsAutorizado, DataTable, IAutorizado

### Community 727 - "Community 727"
Cohesion: 0.24
Nodes (4): clsAdmBanco, clsBanco, DataTable, IBanco

### Community 728 - "Community 728"
Cohesion: 0.24
Nodes (4): clsAdmLinea, clsLinea, DataTable, ILinea

### Community 729 - "Community 729"
Cohesion: 0.24
Nodes (4): clsAdmMarcaTransporte, clsMarcaTransporte, DataTable, IMarcaTransporte

### Community 730 - "Community 730"
Cohesion: 0.24
Nodes (4): clsAdmModeloTransporte, clsModeloTransporte, DataTable, IModeloTransporte

### Community 731 - "Community 731"
Cohesion: 0.20
Nodes (9): clsFacturaVenta, bool, byte, DateTime, decimal, double, int, List (+1 more)
...
Cohesion: 0.22
Nodes (4): clsArqueoFondoFijo, clsDetalleArqueFondoFijo, DataTable, IArqueoFondoFijo

### Community 843 - "Community 843"
Cohesion: 0.28
Nodes (3): clsAutorizado, DataTable, IAutorizado

### Community 844 - "Community 844"
Cohesion: 0.28
Nodes (3): clsCaracteristica, DataTable, ICaracteristica

### Community 845 - "Community 845"
Cohesion: 0.28
Nodes (3): clsGrupo, DataTable, IGrupo

### Community 846 - "Community 846"
Cohesion: 0.28
Nodes (3): clsLinea, DataTable, ILinea

### Community 847 - "Community 847"
Cohesion: 0.28
Nodes (3): clsMarcaTransporte, DataTable, IMarcaTransporte

### Community 848 - "Community 848"
Cohesion: 0.28
Nodes (3): clsModeloTransporte, DataTable, IModeloTransporte

### Community 849 - "Community 849"
Cohesion: 0.28
Nodes (3): clsTipoArticulo, DataTable, ITipoArticulo

### Community 850 - "Community 850"
Cohesion: 0.28
Nodes (3): clsVariante, DataTable, IVariante

### Community 851 - "Community 851"
Cohesion: 0.28
Nodes (6): ClsNotasCreditoDebitoCompra, clsConexionMysql, DataSet, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 852 - "Community 852"
Cohesion: 0.28
Nodes (6): clsNotasCreditoDebitoVenta, clsConexionMysql, DataSet, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 853 - "Community 853"
Cohesion: 0.25
Nodes (7): clsReportAlmacenVendeMas, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 854 - "Community 854"
Cohesion: 0.25
Nodes (7): clsReporteCobrosDia, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 855 - "Community 855"
Cohesion: 0.25
Nodes (7): clsReporteCodigoBarras, clsConexionMysql, DataSet, DataTable, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 856 - "Community 856"
Cohesion: 0.25
Nodes (7): clsReporteDocumentosEnviados, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 857 - "Community 857"
Cohesion: 0.25
Nodes (7): clsReporteGananciaxCliente, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 858 - "Community 858"
Cohesion: 0.25
Nodes (7): clsReportePagos, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 859 - "Community 859"
Cohesion: 0.25
Nodes (7): clsReportePagosDia, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 860 - "Community 860"
Cohesion: 0.25
Nodes (7): clsReporteTransferencia, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 861 - "Community 861"
Cohesion: 0.25
Nodes (7): clsReporteVentaxArticulo, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 862 - "Community 862"
Cohesion: 0.25
Nodes (7): clsReporteVentCredContDia, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 863 - "Community 863"
Cohesion: 0.25
Nodes (7): clsReportMercaderiaxEntregar, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 864 - "Community 864"
Cohesion: 0.25
Nodes (7): clsRotacionProductos, clsConexionMysql, DataSet, DateTime, MySqlCommand, MySqlDataAdapter, MySqlDataReader

### Community 865 - "Community 865"
Cohesion: 0.25
Nodes (4): CrystalReportViewer, EventArgs, IContainer, frmListaVentas

### Community 866 - "Community 866"
Cohesion: 0.25
Nodes (4): CrystalReportViewer, EventArgs, IContainer, frmListaVentasSeparacion
...
Cohesion: 0.17
Nodes (11): 1. Arquitectura y Componentes Relacionados, 2. Funcionamiento Detallado, 3. Casuísticas de Negocio, A. Creación del Saldo Pendiente, B. Amortización de la Deuda (`GuardaPagoPendiente`), Base de Datos (Tablas y SPs), Casuística 1: Reversión de Cobros ("Pasar a Pendiente"), Casuística 2: Flujo de Aprobación de Tesorería (Depósitos, Transferencias y Cheques) (+3 more)
...
Cohesion: 0.50
Nodes (3): clsComposicionQuimica, int, string

### Community 1356 - "Community 1356"
Cohesion: 0.50
Nodes (3): clsDetalleConciliacion, decimal, int

### Community 1357 - "Community 1357"
Cohesion: 0.50
Nodes (3): clsDetalleConsolidado, double, int

### Community 1358 - "Community 1358"
Cohesion: 0.50
Nodes (3): clsDetalleCotizacionPropuestaDePedido, double, int

### Community 1359 - "Community 1359"
Cohesion: 0.50
Nodes (3): clsDocumentoIdentidad, int, string

### Community 1360 - "Community 1360"
Cohesion: 0.50
Nodes (3): clsDosis, int, string

### Community 1361 - "Community 1361"
Cohesion: 0.50
Nodes (3): clsFormulario, int, string

### Community 1362 - "Community 1362"
Cohesion: 0.50
Nodes (3): clsIngresoEgreso, int, string

### Community 1363 - "Community 1363"
Cohesion: 0.50
Nodes (3): clsNotaIngresoIgv, bool, int

### Community 1364 - "Community 1364"
Cohesion: 0.50
Nodes (3): clsOficio, int, string

### Community 1365 - "Community 1365"
Cohesion: 0.50
Nodes (3): clsStatusCajaChica, decimal, int
...
## Knowledge Gaps
- **9057 isolated node(s):** `$schema`, `plugin`, `int`, `string`, `FileStream` (+9052 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **704 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `frmNotadeCredito` connect `Community 8` to `Community 32`, `Community 1255`, `Community 1325`, `Community 654`, `Community 653`, `Community 595`, `Community 377`, `Community 443`, `Community 444`, `Community 1565`?**
...
- **What connects `$schema`, `plugin`, `int` to the rest of the system?**
  _9057 weakly-connected nodes found - possible documentation gaps or missing edges._

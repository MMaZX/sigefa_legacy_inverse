...
internal class clsAdmUnidad
{
	private IUnidad Muni = new MysqlUnidades();
	...
	public DataTable MuestraUnidades1()
	{
		try
		{
			return Muni.ListaUnidades1();
		}
		catch (Exception ex)
		{
			MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
	...
	public clsUnidadMedida CargaUnidad(int uni)
	{
		try
		{

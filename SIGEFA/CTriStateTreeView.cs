...
public class CTriStateTreeView : TreeView
{
	...
	private CTriStateStyles TriStateStyle = CTriStateStyles.Standard;
	...
	public CTriStateStyles TriStateStyleProperty
	{
		get
		{
	...
	protected void UpdateParentState(TreeNode tn)
	{
		...
		if (TriStateStyle == CTriStateStyles.Installer && MixedNodes == 0)
		{
			if (UnCheckedNodes == 0)
			{
				tn.Checked = true;
